...
function SpreadsheetWidget() {
  ...
  useEffect(() => {
    ...
    console.log('Spreadsheet widget initialized with document key:', documentKey);
  }, []); // Run once on mount
