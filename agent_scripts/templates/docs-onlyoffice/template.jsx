...
function DocumentWidget() {
  ...
  useEffect(() => {
    ...
    console.log('Document widget initialized with document key:', documentKey);
  }, []); // Run once on mount
