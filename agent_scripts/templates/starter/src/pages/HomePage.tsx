    ...
    <div className="h-full bg-background overflow-y-auto">
      <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="text-center">
          ...
          {/* Getting Started */}
          <div className="bg-card/60 rounded-xl border border-border p-6 text-left">
            <h2 className="text-lg font-semibold text-foreground mb-4">Getting Started</h2>

            <ul className="space-y-3 text-muted-foreground text-sm">
              <li className="flex items-start gap-3">
                <span className="text-primary mt-0.5">1.</span>
                <span>Edit <code className="text-primary bg-muted px-1.5 py-0.5 rounded text-xs">src/schemas.ts</code> to define your data collections</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="text-primary mt-0.5">2.</span>
                <span>Create pages in <code className="text-primary bg-muted px-1.5 py-0.5 rounded text-xs">src/pages/</code></span>
              </li>
              <li className="flex items-start gap-3">
                <span className="text-primary mt-0.5">3.</span>
                <span>Add routes in <code className="text-primary bg-muted px-1.5 py-0.5 rounded text-xs">src/App.tsx</code></span>
              </li>
            </ul>
