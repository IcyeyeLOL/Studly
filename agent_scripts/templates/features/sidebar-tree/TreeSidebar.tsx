/**
 * Sidebar Component with Hierarchical Navigation + Drag & Drop
 *
 * Features:
...
import { VIEWS, VIEW_CONFIG, type CurrentView, type ViewType } from '../constants/tree-sidebar-constants'
import { useTreeDragDrop } from '../hooks/tree-sidebar-hooks'
...
function Icon({ name, size = 16, className = '' }: IconProps) {
  // This is a placeholder - in production, use your preferred icon library
  // e.g., lucide-react, heroicons, etc.
